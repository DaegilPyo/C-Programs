...
namespace pyo
{
	...
	bool Screen::init() {
		...
		m_buffer1 = new Uint32[(SCREEN_WIDTH * SCREEN_HIEGHT)+ SCREEN_WIDTH];
		m_buffer2 = new Uint32[(SCREEN_WIDTH * SCREEN_HIEGHT)+ SCREEN_WIDTH];

		//----------------------------------------------------------------------------------
		memset(m_buffer1, 0, SCREEN_WIDTH * SCREEN_HIEGHT * sizeof(Uint32));
